package enkan.component.ldaptive.apacheds;
...
public class LdapStandaloneServer {
    ...
    public LdapStandaloneServer() throws Exception {
        ...
        importLdif("src/test/resources/ldap/microsoft.ldif",
                "src/test/resources/ldap/users.ldif");
        ...
        ldapServer.setKeystoreFile("src/test/resources/client.jks");
